/* PrismJS 1.15.0
https://prismjs.com/download.html#themes=prism-okaidia&languages=markup+css+clike+javascript+c+bash+cpp+arduino+coffeescript+ruby+dart+django+docker+elixir+markup-templating+erlang+git+go+graphql+less+haskell+http+java+json+kotlin+latex+markdown+lua+makefile+matlab+nginx+objectivec+perl+php+sql+powershell+scss+python+r+jsx+typescript+stylus+scala+plsql+pug+swift+yaml+haml+tsx&plugins=command-line+normalize-whitespace */
